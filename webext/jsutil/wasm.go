...
// thank you
// https://github.com/earthboundkid/shitpic/blob/master/jsutil/wasm.go
...
func ArrayToValue(values []js.Value) js.Value {
	array := js.Global().Get("Array").New(js.ValueOf(len(values)))
